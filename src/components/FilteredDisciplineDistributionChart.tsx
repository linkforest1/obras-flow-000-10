...
export function FilteredDisciplineDistributionChart({ selectedWeeks = [], selectedDisciplines = [], selectedLocations = [] }: FilteredDisciplineDistributionChartProps) {
  ...
  const filteredActivities = activities.filter(activity => {
    ...
    // Filtro por locais selecionados se fornecido
    if (selectedLocations.length > 0 && !selectedLocations.includes(activity.location || '')) {
      return false;
    }
